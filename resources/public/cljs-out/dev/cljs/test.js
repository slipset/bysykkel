...
var G__24564 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__24564,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__24564;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq24566){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24567,G__24568,seq24566__$2);
});
...
var file = cljs.core.get.call(null,map__24573__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__24573__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__24573__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__24573,map__24573__$1,file,line,column){
return (function (p1__24572_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__24572_SHARP_));
});})(map__24573,map__24573__$1,file,line,column))
...
var temp__5457__auto___24575 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___24575)){
var message_24576 = temp__5457__auto___24575;
cljs.core.println.call(null,message_24576);
} else {
}
...
var temp__5457__auto___24577 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___24577)){
var message_24578 = temp__5457__auto___24577;
cljs.core.println.call(null,message_24578);
} else {
}
...
var output_dir__$1 = (function (){var G__24579 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24579),"/"].join('');
} else {
return G__24579;
}
})();
...
var G__24581__$1 = (((G__24581 == null))?null:clojure.string.split_lines.call(null,G__24581));
var G__24581__$2 = (((G__24581__$1 == null))?null:cljs.core.get.call(null,G__24581__$1,depth));
if((G__24581__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__24581__$2);
}
} else {
...
var vec__24582 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__24582,(0),null);
var column = cljs.core.nth.call(null,vec__24582,(1),null);
var vec__24585 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__24585,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__24585,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__24585,(2),null);
...
var m__$1 = (function (){var G__24588 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__24592 = (function (){var G__24591 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__24591);
} else {
return G__24591;
}
})();
...
return cljs.core.vary_meta.call(null,G__24593,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__24597 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__24597,(0),null);
var types = vec__24597;
...
return cljs.core.map.call(null,(function (p__24600){
var vec__24601 = p__24600;
var ns = cljs.core.nth.call(null,vec__24601,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__24601,(1),null);
return ((function (vec__24601,ns,vars__$1){
return (function (){
...
var G__24604 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__24604,G__24604__$1,env,once_fixtures,each_fixtures,vec__24601,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__24604,G__24604__$1,env,once_fixtures,each_fixtures,vec__24601,ns,vars__$1){
return (function (){
var seq__24605 = cljs.core.seq.call(null,vars__$1);
var chunk__24606 = null;
var count__24607 = (0);
var i__24608 = (0);
while(true){
if((i__24608 < count__24607)){
var v = cljs.core._nth.call(null,chunk__24606,i__24608);
var temp__5457__auto___24610 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___24610)){
var t_24611 = temp__5457__auto___24610;
each_fixture_fn.call(null,((function (seq__24605,chunk__24606,count__24607,i__24608,t_24611,temp__5457__auto___24610,v,each_fixture_fn,G__24604,G__24604__$1,env,once_fixtures,each_fixtures,vec__24601,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_24611)));
});})(seq__24605,chunk__24606,count__24607,i__24608,t_24611,temp__5457__auto___24610,v,each_fixture_fn,G__24604,G__24604__$1,env,once_fixtures,each_fixtures,vec__24601,ns,vars__$1))
);
} else {
}


var G__24612 = seq__24605;
var G__24613 = chunk__24606;
var G__24614 = count__24607;
var G__24615 = (i__24608 + (1));
seq__24605 = G__24612;
chunk__24606 = G__24613;
count__24607 = G__24614;
i__24608 = G__24615;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__24605);
if(temp__5457__auto__){
var seq__24605__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__24605__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__24605__$1);
var G__24616 = cljs.core.chunk_rest.call(null,seq__24605__$1);
var G__24617 = c__4351__auto__;
var G__24618 = cljs.core.count.call(null,c__4351__auto__);
var G__24619 = (0);
seq__24605 = G__24616;
chunk__24606 = G__24617;
count__24607 = G__24618;
i__24608 = G__24619;
continue;
} else {
var v = cljs.core.first.call(null,seq__24605__$1);
var temp__5457__auto___24620__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___24620__$1)){
var t_24621 = temp__5457__auto___24620__$1;
each_fixture_fn.call(null,((function (seq__24605,chunk__24606,count__24607,i__24608,t_24621,temp__5457__auto___24620__$1,v,seq__24605__$1,temp__5457__auto__,each_fixture_fn,G__24604,G__24604__$1,env,once_fixtures,each_fixtures,vec__24601,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_24621)));
});})(seq__24605,chunk__24606,count__24607,i__24608,t_24621,temp__5457__auto___24620__$1,v,seq__24605__$1,temp__5457__auto__,each_fixture_fn,G__24604,G__24604__$1,env,once_fixtures,each_fixtures,vec__24601,ns,vars__$1))
);
} else {
}


var G__24622 = cljs.core.next.call(null,seq__24605__$1);
var G__24623 = null;
var G__24624 = (0);
var G__24625 = (0);
seq__24605 = G__24622;
chunk__24606 = G__24623;
count__24607 = G__24624;
i__24608 = G__24625;
continue;
}
} else {
...
});})(each_fixture_fn,G__24604,G__24604__$1,env,once_fixtures,each_fixtures,vec__24601,ns,vars__$1))
);
});})(each_fixture_fn,G__24604,G__24604__$1,env,once_fixtures,each_fixtures,vec__24601,ns,vars__$1))
], null);
