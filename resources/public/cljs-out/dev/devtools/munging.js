...
var o14739 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14739["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14740 = temp__5455__auto____$1;
return (o14740["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14559__auto__ = f;
return (o__14559__auto__["toString"]).call(o__14559__auto__);
} else {
return "";
}
}catch (e14741){var _ = e14741;
return "";
}});
...
try{var o__14559__auto___14743 = t;
(o__14559__auto___14743["cljs$lang$ctorPrWriter"]).call(o__14559__auto___14743,t,writer);
}catch (e14742){var __14744 = e14742;
}
...
var char_code = (function (){var o__14559__auto__ = (new String(char$));
return (o__14559__auto__["charCodeAt"]).call(o__14559__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14559__auto__ = String;
return (o__14559__auto__["fromCharCode"]).call(o__14559__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14745 = num_code;
switch (G__14745) {
case (1):
return (185);
...
var o__14559__auto__ = String;
return (o__14559__auto__["fromCharCode"]).call(o__14559__auto__,superscript_code);
});
/**
...
}catch (e14747){var _e__14566__auto__ = e14747;
return false;
}})())){
...
var vec__14748 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14748,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o14751 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14751["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14752 = temp__5455__auto____$1;
return (o14752["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14755){
var vec__14756 = p__14755;
var ns_detector = cljs.core.nth.call(null,vec__14756,(0),null);
...
var G__14762 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__14763 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__14762;
remaining_tokens = G__14763;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14753){
...
var vec__14767 = cljs.core.split_with.call(null,(function (p1__14766_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14766_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__14767,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__14767,(1),null);
...
var vec__14770 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__14770,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__14770,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__14773 = cljs.core.rest.call(null,remaining_tokens);
var G__14774 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__14773;
name_tokens = G__14774;
continue;
} else {
...
var vec__14777 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__14777,(0),null);
var arity = cljs.core.nth.call(null,vec__14777,(1),null);
var vec__14780 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__14780,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__14780,(1),null);
var vec__14783 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__14783,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__14783,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__14783,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__14783,(3),null);
...
var vec__14789 = result;
var munged_ns = cljs.core.nth.call(null,vec__14789,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__14789,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__14789,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__14789,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__14789,(4),null);
var arity = cljs.core.nth.call(null,vec__14789,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__14793 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__14793,(0),null);
var args = cljs.core.nth.call(null,vec__14793,(1),null);
var vec__14796 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__14796,(0),null);
var name = cljs.core.nth.call(null,vec__14796,(1),null);
...
var G__14799 = (arity + (1));
var G__14800 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14801){
var vec__14802 = p__14801;
var arity = cljs.core.nth.call(null,vec__14802,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__14802,(1),null);
...
return cljs.core.get.call(null,arities,p1__14805_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__14806_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14809){
var vec__14810 = p__14809;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__14810,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14807){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__14818__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__14818__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__14818__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__14818__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14819 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__14819,(0),null);
var fn_name = cljs.core.nth.call(null,vec__14819,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__14819,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__14819,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__14819,(4),null);
var arity = cljs.core.nth.call(null,vec__14819,(5),null);
...
var o__14559__auto__ = f;
return (o__14559__auto__["getBasis"]).call(o__14559__auto__);
});
/**
...
}catch (e14823){var _e__14566__auto__ = e14823;
...
var G__14824 = (obj[cljs.core.first.call(null,path)]);
var G__14825 = cljs.core.rest.call(null,path);
obj = G__14824;
path = G__14825;
continue;
} else {
...
return (function (accum,p__14826){
var vec__14827 = p__14826;
var bit = cljs.core.nth.call(null,vec__14827,(0),null);
var protocol = cljs.core.nth.call(null,vec__14827,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14830){
var vec__14831 = p__14830;
var ns = cljs.core.nth.call(null,vec__14831,(0),null);
var name = cljs.core.nth.call(null,vec__14831,(1),null);
var selector = cljs.core.nth.call(null,vec__14831,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__14836,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__14836,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__14836,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__14834_SHARP_){
return (obj[cljs.core.first.call(null,p1__14834_SHARP_)]);
});})(name,sorted_matches,vec__14836,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
