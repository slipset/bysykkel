...
var G__9816 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__9816,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__9816;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq9818){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9819,G__9820,seq9818__$2);
});
...
var map__9825 = m;
var map__9825__$1 = ((((!((map__9825 == null)))?(((((map__9825.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9825.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9825):map__9825);
var file = cljs.core.get.call(null,map__9825__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__9825__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__9825__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__9825,map__9825__$1,file,line,column){
return (function (p1__9824_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__9824_SHARP_));
});})(map__9825,map__9825__$1,file,line,column))
...
var temp__5457__auto___9827 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9827)){
var message_9828 = temp__5457__auto___9827;
cljs.core.println.call(null,message_9828);
} else {
}
...
var temp__5457__auto___9829 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9829)){
var message_9830 = temp__5457__auto___9829;
cljs.core.println.call(null,message_9830);
} else {
}
...
var output_dir__$1 = (function (){var G__9831 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9831),"/"].join('');
} else {
return G__9831;
}
})();
...
var G__9833 = exception.stack;
var G__9833__$1 = (((G__9833 == null))?null:clojure.string.split_lines.call(null,G__9833));
var G__9833__$2 = (((G__9833__$1 == null))?null:cljs.core.get.call(null,G__9833__$1,depth));
if((G__9833__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__9833__$2);
}
} else {
...
var vec__9834 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__9834,(0),null);
var column = cljs.core.nth.call(null,vec__9834,(1),null);
var vec__9837 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__9837,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__9837,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__9837,(2),null);
...
var m__$1 = (function (){var G__9840 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__9844 = (function (){var G__9843 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__9843);
} else {
return G__9843;
}
})();
...
return cljs.core.vary_meta.call(null,G__9845,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__9849 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__9849,(0),null);
var types = vec__9849;
...
return cljs.core.map.call(null,(function (p__9852){
var vec__9853 = p__9852;
var ns = cljs.core.nth.call(null,vec__9853,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__9853,(1),null);
return ((function (vec__9853,ns,vars__$1){
return (function (){
...
var G__9856 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__9856__$1 = (((G__9856 instanceof cljs.core.Keyword))?G__9856.fqn:null);
switch (G__9856__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__9856,G__9856__$1,env,once_fixtures,each_fixtures,vec__9853,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__9856,G__9856__$1,env,once_fixtures,each_fixtures,vec__9853,ns,vars__$1){
return (function (){
var seq__9857 = cljs.core.seq.call(null,vars__$1);
var chunk__9858 = null;
var count__9859 = (0);
var i__9860 = (0);
while(true){
if((i__9860 < count__9859)){
var v = cljs.core._nth.call(null,chunk__9858,i__9860);
var temp__5457__auto___9862 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9862)){
var t_9863 = temp__5457__auto___9862;
each_fixture_fn.call(null,((function (seq__9857,chunk__9858,count__9859,i__9860,t_9863,temp__5457__auto___9862,v,each_fixture_fn,G__9856,G__9856__$1,env,once_fixtures,each_fixtures,vec__9853,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9863)));
});})(seq__9857,chunk__9858,count__9859,i__9860,t_9863,temp__5457__auto___9862,v,each_fixture_fn,G__9856,G__9856__$1,env,once_fixtures,each_fixtures,vec__9853,ns,vars__$1))
);
} else {
}


var G__9864 = seq__9857;
var G__9865 = chunk__9858;
var G__9866 = count__9859;
var G__9867 = (i__9860 + (1));
seq__9857 = G__9864;
chunk__9858 = G__9865;
count__9859 = G__9866;
i__9860 = G__9867;
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__9857);
if(temp__5457__auto__){
var seq__9857__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__9857__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__9857__$1);
var G__9868 = cljs.core.chunk_rest.call(null,seq__9857__$1);
var G__9869 = c__4351__auto__;
var G__9870 = cljs.core.count.call(null,c__4351__auto__);
var G__9871 = (0);
seq__9857 = G__9868;
chunk__9858 = G__9869;
count__9859 = G__9870;
...
var v = cljs.core.first.call(null,seq__9857__$1);
var temp__5457__auto___9872__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9872__$1)){
var t_9873 = temp__5457__auto___9872__$1;
each_fixture_fn.call(null,((function (seq__9857,chunk__9858,count__9859,i__9860,t_9873,temp__5457__auto___9872__$1,v,seq__9857__$1,temp__5457__auto__,each_fixture_fn,G__9856,G__9856__$1,env,once_fixtures,each_fixtures,vec__9853,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9873)));
});})(seq__9857,chunk__9858,count__9859,i__9860,t_9873,temp__5457__auto___9872__$1,v,seq__9857__$1,temp__5457__auto__,each_fixture_fn,G__9856,G__9856__$1,env,once_fixtures,each_fixtures,vec__9853,ns,vars__$1))
);
} else {
}


var G__9874 = cljs.core.next.call(null,seq__9857__$1);
var G__9875 = null;
var G__9876 = (0);
var G__9877 = (0);
seq__9857 = G__9874;
...
});})(each_fixture_fn,G__9856,G__9856__$1,env,once_fixtures,each_fixtures,vec__9853,ns,vars__$1))
);
});})(each_fixture_fn,G__9856,G__9856__$1,env,once_fixtures,each_fixtures,vec__9853,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9856__$1)].join('')));

}
})());
});
;})(vec__9853,ns,vars__$1))
