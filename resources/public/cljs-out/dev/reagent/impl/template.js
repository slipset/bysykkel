...
var G__25232 = o;
(G__25232[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25236 = o;
(G__25236[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25241 = props;
var G__25241__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25241,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25241);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25241__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__25242){
var map__25243 = p__25242;
var map__25243__$1 = ((((!((map__25243 == null)))?(((((map__25243.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25243.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25243):map__25243);
var props = map__25243__$1;
var class$ = cljs.core.get.call(null,map__25243__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__25243,map__25243__$1,props,class$){
return (function (c){
...
});})(map__25243,map__25243__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25245){
...
var on_write = cljs.core.get.call(null,map__25246__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__25246,map__25246__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__25246,map__25246__$1,on_write))
);
} else {
...
var G__25249 = jsprops;
(G__25249["defaultValue"] = value);

(G__25249["onChange"] = ((function (G__25249,v,value,on_change){
return (function (p1__25248_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25248_SHARP_);
});})(G__25249,v,value,on_change))
);
...
var vec__25252 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25252,(0),null);
var id = cljs.core.nth.call(null,vec__25252,(1),null);
var class$ = cljs.core.nth.call(null,vec__25252,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___25256 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___25256 == null)){
} else {
var key_25257 = temp__5461__auto___25256;
...
var temp__5461__auto___25258 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___25258 == null)){
} else {
var key_25259 = temp__5461__auto___25258;
reagent.impl.template.oset.call(null,jsprops,"key",key_25259);
}
...
var G__25260 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__25260["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25263){
var G__25264 = cljs.core.first.call(null,seq25263);
var seq25263__$1 = cljs.core.next.call(null,seq25263);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25264,seq25263__$1);
});
...
break;
default:
var G__25270 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25270;
continue;
...
var n__4408__auto___25272 = a.length;
var i_25273 = (0);
while(true){
if((i_25273 < n__4408__auto___25272)){
(a[i_25273] = reagent.impl.template.as_element.call(null,(a[i_25273])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___25275 = a.length;
var i_25276 = (0);
while(true){
if((i_25276 < n__4408__auto___25275)){
var val_25277 = (a[i_25276]);
if(((cljs.core.vector_QMARK_.call(null,val_25277)) && ((reagent.impl.template.key_from_vec.call(null,val_25277) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_25276] = reagent.impl.template.as_element.call(null,val_25277));

var G__25278 = (i_25276 + (1));
i_25276 = G__25278;
continue;
} else {
}
...
var ctx = ({});
var vec__25279 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25279,(0),null);
var derefed = cljs.core.nth.call(null,vec__25279,(1),null);
...
var G__25282 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25282) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__25282){
