...
cljs_test_display.notify.failure = (function cljs_test_display$notify$failure(p__24645){
var map__24646 = p__24645;
var map__24646__$1 = ((((!((map__24646 == null)))?(((((map__24646.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24646.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24646):map__24646);
var error = cljs.core.get.call(null,map__24646__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var fail = cljs.core.get.call(null,map__24646__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
return cljs_test_display.notify.with_permission.call(null,"granted",((function (map__24646,map__24646__$1,error,fail){
return (function (){
...
});})(map__24646,map__24646__$1,error,fail))
);
});
