...
var G__11049 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11049,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11049;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11051){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11052,G__11053,seq11051__$2);
});
...
var map__11058 = m;
var map__11058__$1 = ((((!((map__11058 == null)))?(((((map__11058.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11058.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11058):map__11058);
var file = cljs.core.get.call(null,map__11058__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11058__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11058__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__11058,map__11058__$1,file,line,column){
return (function (p1__11057_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11057_SHARP_));
});})(map__11058,map__11058__$1,file,line,column))
...
var temp__5457__auto___11060 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11060)){
var message_11061 = temp__5457__auto___11060;
cljs.core.println.call(null,message_11061);
} else {
}
...
var temp__5457__auto___11062 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11062)){
var message_11063 = temp__5457__auto___11062;
cljs.core.println.call(null,message_11063);
} else {
}
...
var output_dir__$1 = (function (){var G__11064 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11064),"/"].join('');
} else {
return G__11064;
}
})();
...
var G__11066 = exception.stack;
var G__11066__$1 = (((G__11066 == null))?null:clojure.string.split_lines.call(null,G__11066));
var G__11066__$2 = (((G__11066__$1 == null))?null:cljs.core.get.call(null,G__11066__$1,depth));
if((G__11066__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11066__$2);
}
} else {
...
var vec__11067 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11067,(0),null);
var column = cljs.core.nth.call(null,vec__11067,(1),null);
var vec__11070 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11070,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11070,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11070,(2),null);
...
var m__$1 = (function (){var G__11073 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11077 = (function (){var G__11076 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11076);
} else {
return G__11076;
}
})();
...
return cljs.core.vary_meta.call(null,G__11078,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11082 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11082,(0),null);
var types = vec__11082;
...
return cljs.core.map.call(null,(function (p__11085){
var vec__11086 = p__11085;
var ns = cljs.core.nth.call(null,vec__11086,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11086,(1),null);
return ((function (vec__11086,ns,vars__$1){
return (function (){
...
var G__11089 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__11089,G__11089__$1,env,once_fixtures,each_fixtures,vec__11086,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__11089,G__11089__$1,env,once_fixtures,each_fixtures,vec__11086,ns,vars__$1){
return (function (){
var seq__11090 = cljs.core.seq.call(null,vars__$1);
var chunk__11091 = null;
var count__11092 = (0);
var i__11093 = (0);
while(true){
if((i__11093 < count__11092)){
var v = cljs.core._nth.call(null,chunk__11091,i__11093);
var temp__5457__auto___11095 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11095)){
var t_11096 = temp__5457__auto___11095;
each_fixture_fn.call(null,((function (seq__11090,chunk__11091,count__11092,i__11093,t_11096,temp__5457__auto___11095,v,each_fixture_fn,G__11089,G__11089__$1,env,once_fixtures,each_fixtures,vec__11086,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11096)));
});})(seq__11090,chunk__11091,count__11092,i__11093,t_11096,temp__5457__auto___11095,v,each_fixture_fn,G__11089,G__11089__$1,env,once_fixtures,each_fixtures,vec__11086,ns,vars__$1))
);
} else {
}


var G__11097 = seq__11090;
var G__11098 = chunk__11091;
var G__11099 = count__11092;
var G__11100 = (i__11093 + (1));
seq__11090 = G__11097;
chunk__11091 = G__11098;
count__11092 = G__11099;
i__11093 = G__11100;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__11090);
if(temp__5457__auto__){
var seq__11090__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11090__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__11090__$1);
var G__11101 = cljs.core.chunk_rest.call(null,seq__11090__$1);
var G__11102 = c__4351__auto__;
var G__11103 = cljs.core.count.call(null,c__4351__auto__);
var G__11104 = (0);
seq__11090 = G__11101;
chunk__11091 = G__11102;
count__11092 = G__11103;
i__11093 = G__11104;
continue;
} else {
var v = cljs.core.first.call(null,seq__11090__$1);
var temp__5457__auto___11105__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11105__$1)){
var t_11106 = temp__5457__auto___11105__$1;
each_fixture_fn.call(null,((function (seq__11090,chunk__11091,count__11092,i__11093,t_11106,temp__5457__auto___11105__$1,v,seq__11090__$1,temp__5457__auto__,each_fixture_fn,G__11089,G__11089__$1,env,once_fixtures,each_fixtures,vec__11086,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11106)));
});})(seq__11090,chunk__11091,count__11092,i__11093,t_11106,temp__5457__auto___11105__$1,v,seq__11090__$1,temp__5457__auto__,each_fixture_fn,G__11089,G__11089__$1,env,once_fixtures,each_fixtures,vec__11086,ns,vars__$1))
);
} else {
}


var G__11107 = cljs.core.next.call(null,seq__11090__$1);
var G__11108 = null;
var G__11109 = (0);
var G__11110 = (0);
seq__11090 = G__11107;
chunk__11091 = G__11108;
count__11092 = G__11109;
i__11093 = G__11110;
continue;
}
} else {
...
});})(each_fixture_fn,G__11089,G__11089__$1,env,once_fixtures,each_fixtures,vec__11086,ns,vars__$1))
);
});})(each_fixture_fn,G__11089,G__11089__$1,env,once_fixtures,each_fixtures,vec__11086,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11089__$1)].join('')));

}
})());
});
;})(vec__11086,ns,vars__$1))
