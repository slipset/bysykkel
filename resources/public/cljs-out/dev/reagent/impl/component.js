...
if((i < len)){
var k = (ks[i]);
var G__11558 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__11559 = (i + (1));
m = G__11558;
i = G__11559;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__11561 = c;
var G__11561__$1 = (((G__11561 == null))?null:G__11561.prototype);
if((G__11561__$1 == null)){
return null;
} else {
return (G__11561__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__11563 = c;
var G__11563__$1 = (((G__11563 == null))?null:G__11563.prototype);
if((G__11563__$1 == null)){
return null;
} else {
return (G__11563__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__11566__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__11566 = function (var_args){
var args = null;
...
while (G__11567__i < G__11567__a.length) {G__11567__a[G__11567__i] = arguments[G__11567__i + 0]; ++G__11567__i;}
  args = new cljs.core.IndexedSeq(G__11567__a,0,null);
} 
return G__11566__delegate.call(this,args);};
G__11566.cljs$lang$maxFixedArity = 0;
G__11566.cljs$lang$applyTo = (function (arglist__11568){
var args = cljs.core.seq(arglist__11568);
return G__11566__delegate(args);
});
...
var _STAR_current_component_STAR_11570 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_11570;
}});
...
return ((function (G__11571,G__11571__$1){
...
var c = this;
var G__11576_11578 = (c["cljsRatom"]);
if((G__11576_11578 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__11576_11578);
}
...
var renders_11580 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_11581 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_11580));
if((cljs.core.count.call(null,renders_11580) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_11580))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_11581)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_11581))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__11579 = name;
switch (G__11579) {
case "":
...
var G__11583 = o;
(G__11583[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__11584 = fiber;
var G__11584__$1 = (((G__11584 == null))?null:(G__11584["type"]));
if((G__11584__$1 == null)){
return null;
} else {
return (G__11584__$1["displayName"]);
}
})();
var parent = (function (){var G__11585 = fiber;
if((G__11585 == null)){
return null;
} else {
return (G__11585["return"]);
}
})();
var path = (function (){var G__11586 = parent;
var G__11586__$1 = (((G__11586 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__11586));
if((G__11586__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11586__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__11588 = c;
if((G__11588 == null)){
return null;
} else {
return (G__11588["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11589._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__11591 = c;
if((G__11591 == null)){
return null;
} else {
return (G__11591["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__11593 = c;
if((G__11593 == null)){
return null;
} else {
return G__11593._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__11595 = instance;
if((G__11595 == null)){
return null;
} else {
return (G__11595["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__11596 = instance;
if((G__11596 == null)){
return null;
} else {
return G__11596._currentElement;
}
}
})();
var name = (function (){var G__11597 = elem;
var G__11597__$1 = (((G__11597 == null))?null:(G__11597["type"]));
if((G__11597__$1 == null)){
return null;
} else {
return (G__11597__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__11599 = elem;
if((G__11599 == null)){
return null;
} else {
return (G__11599["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11600._owner;
}
}
})();
var path = (function (){var G__11601 = owner;
var G__11601__$1 = (((G__11601 == null))?null:reagent.impl.component.component_path.call(null,G__11601));
if((G__11601__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11601__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__11602 = c;
var G__11602__$1 = (((G__11602 == null))?null:G__11602.constructor);
if((G__11602__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__11602__$1);
}
}
})();
