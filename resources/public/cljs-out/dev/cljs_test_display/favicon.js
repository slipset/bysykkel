...
return cljs.core.map.call(null,(function (p1__24635_SHARP_){
return html_coll.item(p1__24635_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__24636_SHARP_);
...
var ctx_24637 = cvs.getContext("2d");
ctx_24637.fillStyle = color;

ctx_24637.fillRect((0),(0),size,size);
