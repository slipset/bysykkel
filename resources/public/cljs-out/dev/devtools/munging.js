...
var o26355 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26355["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26356 = temp__5455__auto____$1;
return (o26356["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__10685__auto___26359 = t;
(o__10685__auto___26359["cljs$lang$ctorPrWriter"]).call(o__10685__auto___26359,t,writer);
}catch (e26358){var __26360 = e26358;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26361 = num_code;
switch (G__26361) {
case (1):
return (185);
...
}catch (e26363){var _e__10692__auto__ = e26363;
return false;
}})())){
...
var vec__26364 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26364,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o26367 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26367["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26368 = temp__5455__auto____$1;
return (o26368["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___26375 = arguments.length;
var i__4532__auto___26376 = (0);
while(true){
if((i__4532__auto___26376 < len__4531__auto___26375)){
args__4534__auto__.push((arguments[i__4532__auto___26376]));

var G__26377 = (i__4532__auto___26376 + (1));
i__4532__auto___26376 = G__26377;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26371){
var vec__26372 = p__26371;
var ns_detector = cljs.core.nth.call(null,vec__26372,(0),null);
...
var G__26378 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26379 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26378;
remaining_tokens = G__26379;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26369){
var G__26370 = cljs.core.first.call(null,seq26369);
var seq26369__$1 = cljs.core.next.call(null,seq26369);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26370,seq26369__$1);
});
...
var vec__26383 = cljs.core.split_with.call(null,(function (p1__26382_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26382_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26383,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26383,(1),null);
...
var vec__26386 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26386,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26386,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26389 = cljs.core.rest.call(null,remaining_tokens);
var G__26390 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26389;
name_tokens = G__26390;
continue;
} else {
...
var vec__26393 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26393,(0),null);
var arity = cljs.core.nth.call(null,vec__26393,(1),null);
var vec__26396 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26396,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26396,(1),null);
var vec__26399 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26399,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26399,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26399,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26399,(3),null);
...
var vec__26405 = result;
var munged_ns = cljs.core.nth.call(null,vec__26405,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26405,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26405,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26405,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26405,(4),null);
var arity = cljs.core.nth.call(null,vec__26405,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__26409 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__26409,(0),null);
var args = cljs.core.nth.call(null,vec__26409,(1),null);
var vec__26412 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26412,(0),null);
var name = cljs.core.nth.call(null,vec__26412,(1),null);
...
var G__26415 = (arity + (1));
var G__26416 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26417){
var vec__26418 = p__26417;
var arity = cljs.core.nth.call(null,vec__26418,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26418,(1),null);
...
return cljs.core.get.call(null,arities,p1__26421_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26422_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___26429 = arguments.length;
var i__4532__auto___26430 = (0);
while(true){
if((i__4532__auto___26430 < len__4531__auto___26429)){
args__4534__auto__.push((arguments[i__4532__auto___26430]));

var G__26431 = (i__4532__auto___26430 + (1));
i__4532__auto___26430 = G__26431;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26425){
var vec__26426 = p__26425;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26426,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26423){
var G__26424 = cljs.core.first.call(null,seq26423);
var seq26423__$1 = cljs.core.next.call(null,seq26423);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26424,seq26423__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26434__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26434__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26434__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26434__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26435 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26435,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26435,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26435,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26435,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26435,(4),null);
var arity = cljs.core.nth.call(null,vec__26435,(5),null);
...
}catch (e26439){var _e__10692__auto__ = e26439;
...
var G__26440 = (obj[cljs.core.first.call(null,path)]);
var G__26441 = cljs.core.rest.call(null,path);
obj = G__26440;
path = G__26441;
continue;
} else {
...
return (function (accum,p__26442){
var vec__26443 = p__26442;
var bit = cljs.core.nth.call(null,vec__26443,(0),null);
var protocol = cljs.core.nth.call(null,vec__26443,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26446){
var vec__26447 = p__26446;
var ns = cljs.core.nth.call(null,vec__26447,(0),null);
var name = cljs.core.nth.call(null,vec__26447,(1),null);
var selector = cljs.core.nth.call(null,vec__26447,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__26452,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26452,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26452,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26450_SHARP_){
return (obj[cljs.core.first.call(null,p1__26450_SHARP_)]);
});})(name,sorted_matches,vec__26452,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
